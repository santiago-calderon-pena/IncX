...
from incx.dependencies.d_rise.vision_explanation_methods.explanations.common import (
    DetectionRecord,
...
def DRISE_saliency(
    ...
    for i, _ in enumerate(mask_iterator):
        mask = generate_mask(mask_res, img_size, mask_padding, device, seed = i + seed_start)
